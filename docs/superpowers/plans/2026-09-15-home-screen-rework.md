 ...
 * 半径 102.5;星星在节点**下方**,星心 -136、星底 -161.5;当前关呼吸到上限 1.26 时
 * 顶沿 102.5 x 1.26 = 129.2。最坏的相邻组合是**已通关在上、当前关在下**:
 * 161.5 + 129.2 + 30(间隙) = 320.7。取 340,留约 19 的余量。
 * 旧的胶囊只有 148 高,272 才勉强够。
 *
