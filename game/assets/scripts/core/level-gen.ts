 ...
 * 24) and 5 turn a passing offset failing (id 6 at offset 20, 32; id 7 at offset 20, 32; id 8 at
 * offset 8). Id 5 is untouched at every offset and every depth. But at the four offsets this
 * table actually ships for ids 5-8 -- 16, 20, 24, 28 -- only one of those twelve flips lands: id
