 ...
 * one length per shape: 24 for the four quadrilaterals, 16 for the circle, whose perimeter
...
const TRACK_CURVE: TrackParams[] = [
    ...
    { track: 'hex',    capacity: 24, feeds: TWIN },
    { track: 'trap',   capacity: 24, feeds: [{ side: 'far', lookahead: 3 }, { side: 'near', lookahead: 2 }] },
    { track: 'oval',   capacity: 24, feeds: [{ side: 'far', lookahead: 2 }, { side: 'near', lookahead: 2 }] },
    { track: 'rect',   capacity: 24, feeds: [{ side: 'far', lookahead: 2 }, { side: 'near', lookahead: 2 }] },
    { track: 'hex',    capacity: 24, feeds: [{ side: 'far', lookahead: 2 }, { side: 'near', lookahead: 1 }] },
    { track: 'trap',   capacity: 24, feeds: [{ side: 'far', lookahead: 2 }] },
    { track: 'oval',   capacity: 24, feeds: [{ side: 'far', lookahead: 1 }, { side: 'near', lookahead: 1 }] },
    { track: 'circle', capacity: 16, feeds: [{ side: 'near', lookahead: 2 }] },
    { track: 'circle', capacity: 16, feeds: [{ side: 'near', lookahead: 1 }] },
];
